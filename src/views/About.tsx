...
export function About() {
  const linkClasses = useRef('underline text-[#2563eb]').current;
  return (
    <div>
      ...
      <a className={linkClasses} href="https://chessvision.ai">
        ChessVision.ai
      </a>
      .<br></br>
      <br></br>
      ...
      <a className={linkClasses} href="https://opensource.org/license/mit/">
        MIT license
      </a>
